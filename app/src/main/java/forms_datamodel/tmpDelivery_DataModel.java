...
public class tmpDelivery_DataModel {
    ...
    public void setPregOccurID(String newValue){
       ...
       public List<tmpDelivery_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<tmpDelivery_DataModel> data = new ArrayList<tmpDelivery_DataModel>();
