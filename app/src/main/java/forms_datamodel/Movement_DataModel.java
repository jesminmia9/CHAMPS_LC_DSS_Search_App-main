...
import android.content.Context;
 ...
 public class Movement_DataModel{
     ...
     public void setMoveAddress(String newValue){
        ...
        public List<Movement_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Movement_DataModel> data = new ArrayList<Movement_DataModel>();
            Movement_DataModel d = new Movement_DataModel();
