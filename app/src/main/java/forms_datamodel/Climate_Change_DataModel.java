...
import android.content.Context;
 ...
 public class Climate_Change_DataModel{
        ...
        String TableName = "Climate_Change";
...
//                 manageAudit(context,this,AuditTrial.KEY_UPDATE);
        ...
        public List<Climate_Change_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Climate_Change_DataModel> data = new ArrayList<Climate_Change_DataModel>();
            Climate_Change_DataModel d = new Climate_Change_DataModel();
            ...
            {
                Count += 1;
                d = new Climate_Change_DataModel();
                d._Count = Count;
