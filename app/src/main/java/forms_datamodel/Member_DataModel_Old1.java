...
public class Member_DataModel_Old1 {
     ...
     public void set_isdelete(String _isdelete) {
        ...
        public List<Member_DataModel_Old1> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Member_DataModel_Old1> data = new ArrayList<Member_DataModel_Old1>();
    ...
    public List<Member_DataModel_Old1> SelectMember(Context context, String SQL) {
        Connection C = new Connection(context);
        List<Member_DataModel_Old1> data = new ArrayList<>();
        Member_DataModel_Old1 d;
        Cursor cur = C.ReadData(SQL);
    ...
    @SuppressLint("Range")
     public List<Member_DataModel_Old1> SelectMemberMigration(Context context, String SQL)
     {
         Connection C = new Connection(context);
         List<Member_DataModel_Old1> data = new ArrayList<Member_DataModel_Old1>();
         Member_DataModel_Old1 d = new Member_DataModel_Old1();
...
//             d._vacc = cur.getString(cur.getColumnIndex("vacc"));
     ...
     @SuppressLint("Range")
     public List<Member_DataModel_Old1> SelectAll_MemberEvent(Context context, String SQL)
     {
         C = new Connection(context);
         List<Member_DataModel_Old1> data = new ArrayList<Member_DataModel_Old1>();
         Member_DataModel_Old1 d = new Member_DataModel_Old1();
