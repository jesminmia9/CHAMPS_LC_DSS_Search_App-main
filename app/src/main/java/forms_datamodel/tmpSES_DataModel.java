...
public class tmpSES_DataModel {
    ...
    public void setBlender(String newValue){
       ...
       public List<tmpSES_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<tmpSES_DataModel> data = new ArrayList<tmpSES_DataModel>();
    ...
    public List<tmpSES_DataModel> SelectAll_List(Context context, String SQL)
    {
        Connection C = new Connection(context);
        List<tmpSES_DataModel> data = new ArrayList<tmpSES_DataModel>();
        tmpSES_DataModel d = new tmpSES_DataModel();
