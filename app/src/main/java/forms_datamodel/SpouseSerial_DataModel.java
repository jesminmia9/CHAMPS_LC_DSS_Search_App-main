...
import android.content.Context;
 ...
 public class SpouseSerial_DataModel{
        ...
        public List<SpouseSerial_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<SpouseSerial_DataModel> data = new ArrayList<SpouseSerial_DataModel>();
            SpouseSerial_DataModel d = new SpouseSerial_DataModel();
