...
import android.content.Context;
 ...
 public class Migration_DataModel{
     ...
     public void setMigNotDisUnionDate(String newValue){
        ...
        public List<Migration_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Migration_DataModel> data = new ArrayList<Migration_DataModel>();
