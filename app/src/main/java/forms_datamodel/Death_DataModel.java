...
import android.content.Context;
 ...
 public class Death_DataModel{
     ...
     public void setDthChampsId(String newValue){
        ...
        public List<Death_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Death_DataModel> data = new ArrayList<Death_DataModel>();
            Death_DataModel d = new Death_DataModel();
