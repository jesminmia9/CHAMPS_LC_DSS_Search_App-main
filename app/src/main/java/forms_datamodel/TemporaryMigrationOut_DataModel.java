...
import android.content.ContentValues;
 public class TemporaryMigrationOut_DataModel{
     ...
     public void setMigReasonOth(String newValue){
        ...
        String TableName = "TemporaryMigrationOut";
        ...
        public List<TemporaryMigrationOut_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<TemporaryMigrationOut_DataModel> data = new ArrayList<TemporaryMigrationOut_DataModel>();
            TemporaryMigrationOut_DataModel d = new TemporaryMigrationOut_DataModel();
            ...
            {
                Count += 1;
                d = new TemporaryMigrationOut_DataModel();
                d._Count = Count;
        ...
        public void manageAudit(Context context, TemporaryMigrationOut_DataModel ob, String key) {
        ...
        * @return
        */
        public Map<String, Object> getMapData(TemporaryMigrationOut_DataModel ob) {
