...
public class LiveBirth_DataModel {
    ...
    @SuppressLint("Range")
    public List<LiveBirth_DataModel> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<LiveBirth_DataModel> data = new ArrayList<LiveBirth_DataModel>();
