...
import android.content.ContentValues;
 public class TemporaryMigrationIn_DataModel{
     ...
     public void setMigReasonOth(String newValue){
        ...
        String TableName = "TemporaryMigrationIn";
        ...
        public List<TemporaryMigrationIn_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<TemporaryMigrationIn_DataModel> data = new ArrayList<TemporaryMigrationIn_DataModel>();
            TemporaryMigrationIn_DataModel d = new TemporaryMigrationIn_DataModel();
            ...
            {
                Count += 1;
                d = new TemporaryMigrationIn_DataModel();
                d._Count = Count;
        ...
        public void manageAudit(Context context, TemporaryMigrationIn_DataModel ob, String key) {
        ...
        * @return
        */
        public Map<String, Object> getMapData(TemporaryMigrationIn_DataModel ob) {
