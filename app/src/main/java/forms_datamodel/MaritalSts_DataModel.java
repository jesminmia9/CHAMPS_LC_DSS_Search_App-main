...
public class MaritalSts_DataModel {
    ...
    public List<MaritalSts_DataModel> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<MaritalSts_DataModel> data = new ArrayList<MaritalSts_DataModel>();
        MaritalSts_DataModel d = new MaritalSts_DataModel();
        Cursor cur = C.ReadData(SQL);

        cur.moveToFirst();
        while (!cur.isAfterLast()) {
            Count += 1;
            d = new MaritalSts_DataModel();
            d._Count = Count;
    ...
    public List<MaritalSts_DataModel> SelectAllByMember(Context context, String SQL) {
        Log.d("JM", SQL);
        Connection C = new Connection(context);
        List<MaritalSts_DataModel> data = new ArrayList<MaritalSts_DataModel>();
        MaritalSts_DataModel d = new MaritalSts_DataModel();
