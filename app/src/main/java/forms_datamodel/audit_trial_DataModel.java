...
public class audit_trial_DataModel {
        ...
        public List<audit_trial_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<audit_trial_DataModel> data = new ArrayList<audit_trial_DataModel>();
            audit_trial_DataModel d = new audit_trial_DataModel();
            ...
            {
                Count += 1;
                d = new audit_trial_DataModel();
                d._Count = Count;
                d._audit_id = cur.getString(cur.getColumnIndex("audit_id"));
                d._table_name = cur.getString(cur.getColumnIndex("table_name"));
                d._data_id = cur.getString(cur.getColumnIndex("data_id"));
                d._variable_name = cur.getString(cur.getColumnIndex("variable_name"));
                d._old_value = cur.getString(cur.getColumnIndex("old_value"));
                d._new_value = cur.getString(cur.getColumnIndex("new_value"));
                data.add(d);
