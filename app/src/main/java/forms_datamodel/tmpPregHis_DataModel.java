...
public class tmpPregHis_DataModel {
       ...
       public List<tmpPregHis_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<tmpPregHis_DataModel> data = new ArrayList<tmpPregHis_DataModel>();
    ...
    public String getDataName(String memID, Context context) {
        Connection C = new Connection(context);
        String result = "";
        String query = "SELECT ObsVStatus FROM tmpPregHis WHERE MemID = '"+ memID +"'";
