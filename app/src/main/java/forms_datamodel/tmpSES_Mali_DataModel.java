...
public class tmpSES_Mali_DataModel {
       ...
       public List<tmpSES_Mali_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<tmpSES_Mali_DataModel> data = new ArrayList<tmpSES_Mali_DataModel>();
       ...
       public void manageAudit(Context context, tmpSES_Mali_DataModel ob, String key) {
       ...
       * @return
       */
       public Map<String, Object> getMapData(tmpSES_Mali_DataModel ob) {
