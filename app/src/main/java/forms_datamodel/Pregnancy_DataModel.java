...
import android.content.Context;
 ...
 public class Pregnancy_DataModel{
     ...
     public void setPregWishEnroll(String newValue){
        ...
        public List<Pregnancy_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Pregnancy_DataModel> data = new ArrayList<Pregnancy_DataModel>();
            Pregnancy_DataModel d = new Pregnancy_DataModel();
