...
public class tmpSES_CrossRiver_DataModel {
    ...
    public void setBoatWithMot(String newValue){
       ...
       String TableName = "tmpSES_CrossRiver";
       ...
       @SuppressLint("Range")
       public List<tmpSES_CrossRiver_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<tmpSES_CrossRiver_DataModel> data = new ArrayList<tmpSES_CrossRiver_DataModel>();
           ...
           {
               Count += 1;
               d = new tmpSES_CrossRiver_DataModel();
               d._Count = Count;
       ...
       public void manageAudit(Context context, tmpSES_CrossRiver_DataModel ob, String key) {
       ...
       * @return
       */
       public Map<String, Object> getMapData(tmpSES_CrossRiver_DataModel ob) {
