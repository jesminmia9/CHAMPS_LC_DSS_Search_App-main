...
import android.content.ContentValues;
 public class Household_DataModel{
     ...
     public String getExType(){return _ExType; }

     public List<Household_DataModel> SelectHHList(Context context, String SQL)
     {
         Connection C = new Connection(context);
         List<Household_DataModel> data = new ArrayList<Household_DataModel>();
         Household_DataModel d = new Household_DataModel();
     ...
     public void manageAudit(Context context, Household_DataModel ob, String key) {
      ...
      * @return
      */
     public Map<String, Object> getMapData(Household_DataModel ob) {
