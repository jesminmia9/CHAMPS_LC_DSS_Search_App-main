...
import android.content.Context;
 ...
 public class Education_DataModel{
        ...
        public List<Education_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<Education_DataModel> data = new ArrayList<Education_DataModel>();
