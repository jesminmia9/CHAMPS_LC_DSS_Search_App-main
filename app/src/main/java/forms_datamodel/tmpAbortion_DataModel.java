...
public class tmpAbortion_DataModel {
    ...
    public List<tmpAbortion_DataModel> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<tmpAbortion_DataModel> data = new ArrayList<tmpAbortion_DataModel>();
