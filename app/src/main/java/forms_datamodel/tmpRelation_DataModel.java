...
public class tmpRelation_DataModel {
    ...
    public List<tmpRelation_DataModel> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<tmpRelation_DataModel> data = new ArrayList<tmpRelation_DataModel>();
        ...
        while (!cur.isAfterLast()) {
            ...
            d._HeadShipRth = cur.getString(cur.getColumnIndex("HeadShipRth"));
