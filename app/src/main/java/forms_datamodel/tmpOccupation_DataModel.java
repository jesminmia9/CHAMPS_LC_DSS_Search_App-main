...
public class tmpOccupation_DataModel {
    ...
    public void setOldEmpStat(String newValue){
       ...
       String TableName = "tmpOccupation";
           ...
           try
             {
                ...
                contentValues.put("NewEmplomentStatus", _NewEmpStat);
       ...
       public List<tmpOccupation_DataModel> SelectAll(Context context, String SQL)
       {
           Connection C = new Connection(context);
           List<tmpOccupation_DataModel> data = new ArrayList<tmpOccupation_DataModel>();
           ...
           while(!cur.isAfterLast())
           {
               ...
               d._NewEmpStat = cur.getString(cur.getColumnIndex("NewEmplomentStatus"));
