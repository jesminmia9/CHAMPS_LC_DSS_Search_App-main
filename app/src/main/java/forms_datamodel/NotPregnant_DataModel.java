...
import android.content.Context;
 ...
 public class NotPregnant_DataModel{
     ...
     public void setRnd(String newValue){
        ...
        public List<NotPregnant_DataModel> SelectAll(Context context, String SQL)
        {
            Connection C = new Connection(context);
            List<NotPregnant_DataModel> data = new ArrayList<NotPregnant_DataModel>();
            NotPregnant_DataModel d = new NotPregnant_DataModel();
