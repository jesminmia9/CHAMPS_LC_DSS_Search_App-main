...
public class tmpStillBirth_DataModel {
    ...
    String TableName = "tmpStillBirth";
    ...
    public List<tmpStillBirth_DataModel> SelectAll(Context context, String SQL) {
        Connection C = new Connection(context);
        List<tmpStillBirth_DataModel> data = new ArrayList<tmpStillBirth_DataModel>();
    ...
    @SuppressLint("Range")
    public tmpStillBirth_DataModel SelectSingle(Context context, String SQL) {
        Connection C = new Connection(context);
        tmpStillBirth_DataModel d = new tmpStillBirth_DataModel();
        Cursor cur = C.ReadData(SQL);
