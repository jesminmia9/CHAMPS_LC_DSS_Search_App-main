    ...
    public void saveAll( List<audit_trial_DataModel> dataModelList){
        ...
        try {
            if (dataModelList != null && !dataModelList.isEmpty()){
                ...
                //String tableColumns = "audit_id,table_name,data_id,variable_name,old_value,new_value,StartTime,EndTime,DeviceID,EntryUser,Lat,Lon,EnDt,Upload,modifyDate";
                ...
                //Log.d("TAG", "saveAll: final_query "+ SQLBuilder.toString());
